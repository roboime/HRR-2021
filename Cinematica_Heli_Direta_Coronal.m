...
Z_D(1)=0;
    ...
    for cont_passos=1:passos
        ...
        for j=1:round(gait/taxa) 
            ...
            q(1)=-ang_q*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));%*(-1^(cont_passos));
            q(2)=ang_q*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));%*(-1^(cont_passos));
            q(3)=-ang_q*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));%*(-1^(cont_passos));
            q(4)=ang_q*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));%*(-1^(cont_passos));
            if 0%j>Pc_g*round(gait/taxa)
                if j>2
            ...
            Q(round(gait/taxa)*(cont_passos-1)+j+1,5)=-ang_tr*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));
            Q(round(gait/taxa)*(cont_passos-1)+j+1,6)=ang_tr*sin(pi*taxa*j/gait)*(-1)^(1-mod(cont_passos,2));
            if mod(cont_passos,2)==1
